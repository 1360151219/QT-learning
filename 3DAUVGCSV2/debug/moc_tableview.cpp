...
#include "../../3DAUVGCSV2/tableview.h"
...
QT_MOC_LITERAL(1, 10, 11), // "leftClicked"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 11), // "QModelIndex"
QT_MOC_LITERAL(4, 35, 12) // "rightClicked"

    },
    "TableView\0leftClicked\0\0QModelIndex\0"
    "rightClicked"
};
...
void TableView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->leftClicked((*reinterpret_cast< QModelIndex(*)>(_a[1]))); break;
        case 1: _t->rightClicked((*reinterpret_cast< QModelIndex(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (TableView::*)(QModelIndex );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TableView::leftClicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (TableView::*)(QModelIndex );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TableView::rightClicked)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void TableView::leftClicked(QModelIndex _t1)
{
...
// SIGNAL 1
void TableView::rightClicked(QModelIndex _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };

...
#include "../../3DAUVGCSV2/taskwidget.h"
...
QT_MOC_LITERAL(3, 24, 16), // "getWaypointsList"
QT_MOC_LITERAL(4, 41, 16), // "QList<Waypoint>*"
QT_MOC_LITERAL(5, 58, 13), // "onItemChanged"
QT_MOC_LITERAL(6, 72, 14), // "QStandardItem*"
QT_MOC_LITERAL(7, 87, 4) // "item"

    },
    "TaskWidget\0itemChanged\0\0getWaypointsList\0"
    "QList<Waypoint>*\0onItemChanged\0"
    "QStandardItem*\0item"
};
...
void TaskWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->itemChanged((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        case 1: _t->getWaypointsList((*reinterpret_cast< QList<Waypoint>*(*)>(_a[1]))); break;
        ...
        {
            using _t = void (TaskWidget::*)(double , double , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TaskWidget::itemChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TaskWidget::itemChanged(double _t1, double _t2, int _t3)
{

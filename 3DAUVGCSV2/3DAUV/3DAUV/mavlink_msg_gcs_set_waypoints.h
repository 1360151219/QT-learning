...
#define MAVLINK_MSG_ID_GCS_SET_WAYPOINTS 154

MAVPACKED(
typedef struct __mavlink_gcs_set_waypoints_t {
 int32_t waypoint_lng; /*< [degE7] */
 int32_t waypoint_lat; /*< [degE7] */
 float waypoint_depth; /*< [m] */
 uint8_t waypoint_index; /*<  */
}) mavlink_gcs_set_waypoints_t;

#define MAVLINK_MSG_ID_GCS_SET_WAYPOINTS_LEN 13
#define MAVLINK_MSG_ID_GCS_SET_WAYPOINTS_MIN_LEN 13
#define MAVLINK_MSG_ID_154_LEN 13
#define MAVLINK_MSG_ID_154_MIN_LEN 13

#define MAVLINK_MSG_ID_GCS_SET_WAYPOINTS_CRC 83
#define MAVLINK_MSG_ID_154_CRC 83
...
#define MAVLINK_MESSAGE_INFO_GCS_SET_WAYPOINTS { \
    ...
    "GCS_SET_WAYPOINTS", \
    4, \
    {  { "waypoint_index", NULL, MAVLINK_TYPE_UINT8_T, 0, 12, offsetof(mavlink_gcs_set_waypoints_t, waypoint_index) }, \
         ...
         { "waypoint_depth", NULL, MAVLINK_TYPE_FLOAT, 0, 8, offsetof(mavlink_gcs_set_waypoints_t, waypoint_depth) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_GCS_SET_WAYPOINTS { \
...
static inline uint16_t mavlink_msg_gcs_set_waypoints_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t waypoint_index, int32_t waypoint_lng, int32_t waypoint_lat, float waypoint_depth)
{
    ...
    _mav_put_float(buf, 8, waypoint_depth);
    _mav_put_uint8_t(buf, 12, waypoint_index);
    ...
    packet.waypoint_depth = waypoint_depth;
...
{
    return mavlink_msg_gcs_set_waypoints_pack(system_id, component_id, msg, gcs_set_waypoints->waypoint_index, gcs_set_waypoints->waypoint_lng, gcs_set_waypoints->waypoint_lat, gcs_set_waypoints->waypoint_depth);
}
...
{
    return mavlink_msg_gcs_set_waypoints_pack_chan(system_id, component_id, chan, msg, gcs_set_waypoints->waypoint_index, gcs_set_waypoints->waypoint_lng, gcs_set_waypoints->waypoint_lat, gcs_set_waypoints->waypoint_depth);
}
...
static inline void mavlink_msg_gcs_set_waypoints_send(mavlink_channel_t chan, uint8_t waypoint_index, int32_t waypoint_lng, int32_t waypoint_lat, float waypoint_depth)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_GCS_SET_WAYPOINTS_LEN];
    _mav_put_int32_t(buf, 0, waypoint_lng);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_gcs_set_waypoints_send(chan, gcs_set_waypoints->waypoint_index, gcs_set_waypoints->waypoint_lng, gcs_set_waypoints->waypoint_lat, gcs_set_waypoints->waypoint_depth);
#else
 ...
 */
static inline void mavlink_msg_gcs_set_waypoints_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t waypoint_index, int32_t waypoint_lng, int32_t waypoint_lat, float waypoint_depth)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field waypoint_depth from gcs_set_waypoints message
 *
 * @return [m] 
 */
static inline float mavlink_msg_gcs_set_waypoints_get_waypoint_depth(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_gcs_set_waypoints_decode(const mavlink_message_t* msg, mavlink_gcs_set_waypoints_t* gcs_set_waypoints)
{
    ...
    gcs_set_waypoints->waypoint_depth = mavlink_msg_gcs_set_waypoints_get_waypoint_depth(msg);

...
void USV::getBalls(int ballId, double ballLng, double ballLat, int ballColor)
{
    ...
    {
    case 0:
        balls.append(new BALL(ballLng, ballLat, red));
        break;
    case 1:
        balls.append(new BALL(ballLng, ballLat, blue));
        break;
    case 2:
        balls.append(new BALL(ballLng, ballLat, yellow));
        break;
    case 3:
        balls.append(new BALL(ballLng, ballLat, green));
        break;
    case 4:
        balls.append(new BALL(ballLng, ballLat, black));
        break;
    default:
        break;
    }

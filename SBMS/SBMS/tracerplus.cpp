...
void TracerPlus::setVisible(bool _visible)
{
    visible = _visible;
    tracer->setVisible(_visible);
    dlabel->setVisible(_visible);
    darrow->setVisible(_visible);
    xlabel->setVisible(_visible);
    xarrow->setVisible(_visible);
}

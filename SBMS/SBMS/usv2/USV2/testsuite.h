...
static void mavlink_test_usv_state(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_usv_state_t packet_in = {
		963497464,963497672,73.0,101.0,129.0,157.0,185.0,213.0,241.0,269.0,297.0,325.0,353.0,161
    };
	...
	mavlink_msg_usv_state_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_usv_state_pack(system_id, component_id, &msg , packet1.mode , packet1.lng , packet1.lat , packet1.x , packet1.y , packet1.yaw , packet1.pitch , packet1.heel , packet1.velocity , packet1.course , packet1.rudder , packet1.GyroZ , packet1.electric_current , packet1.voltage );
	mavlink_msg_usv_state_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_usv_state_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.mode , packet1.lng , packet1.lat , packet1.x , packet1.y , packet1.yaw , packet1.pitch , packet1.heel , packet1.velocity , packet1.course , packet1.rudder , packet1.GyroZ , packet1.electric_current , packet1.voltage );
	mavlink_msg_usv_state_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_usv_state_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_usv_state_send(MAVLINK_COMM_1 , packet1.mode , packet1.lng , packet1.lat , packet1.x , packet1.y , packet1.yaw , packet1.pitch , packet1.heel , packet1.velocity , packet1.course , packet1.rudder , packet1.GyroZ , packet1.electric_current , packet1.voltage );
	mavlink_msg_usv_state_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

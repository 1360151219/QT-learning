...
#define MAVLINK_MSG_ID_USV_STATE_LEN 53
#define MAVLINK_MSG_ID_USV_STATE_MIN_LEN 53
#define MAVLINK_MSG_ID_150_LEN 53
#define MAVLINK_MSG_ID_150_MIN_LEN 53

#define MAVLINK_MSG_ID_USV_STATE_CRC 177
#define MAVLINK_MSG_ID_150_CRC 177
...
#define MAVLINK_MESSAGE_INFO_USV_STATE { \
	...
	{  { "lng", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_usv_state_t, lng) }, \
         ...
         { "course", NULL, MAVLINK_TYPE_FLOAT, 0, 32, offsetof(mavlink_usv_state_t, course) }, \
         { "rudder", NULL, MAVLINK_TYPE_FLOAT, 0, 36, offsetof(mavlink_usv_state_t, rudder) }, \
         { "GyroZ", NULL, MAVLINK_TYPE_FLOAT, 0, 40, offsetof(mavlink_usv_state_t, GyroZ) }, \
         { "electric_current", NULL, MAVLINK_TYPE_FLOAT, 0, 44, offsetof(mavlink_usv_state_t, electric_current) }, \
         { "voltage", NULL, MAVLINK_TYPE_FLOAT, 0, 48, offsetof(mavlink_usv_state_t, voltage) }, \
         { "mode", NULL, MAVLINK_TYPE_UINT8_T, 0, 52, offsetof(mavlink_usv_state_t, mode) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_USV_STATE { \
...
static inline uint16_t mavlink_msg_usv_state_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint8_t mode, uint32_t lng, uint32_t lat, float x, float y, float yaw, float pitch, float heel, float velocity, float course, float rudder, float GyroZ, float electric_current, float voltage)
{
	...
	_mav_put_float(buf, 40, GyroZ);
	_mav_put_float(buf, 44, electric_current);
	_mav_put_float(buf, 48, voltage);
...
{
	return mavlink_msg_usv_state_pack(system_id, component_id, msg, usv_state->mode, usv_state->lng, usv_state->lat, usv_state->x, usv_state->y, usv_state->yaw, usv_state->pitch, usv_state->heel, usv_state->velocity, usv_state->course, usv_state->rudder, usv_state->GyroZ, usv_state->electric_current, usv_state->voltage);
}
...
{
	return mavlink_msg_usv_state_pack_chan(system_id, component_id, chan, msg, usv_state->mode, usv_state->lng, usv_state->lat, usv_state->x, usv_state->y, usv_state->yaw, usv_state->pitch, usv_state->heel, usv_state->velocity, usv_state->course, usv_state->rudder, usv_state->GyroZ, usv_state->electric_current, usv_state->voltage);
}
...
static inline void mavlink_msg_usv_state_send(mavlink_channel_t chan, uint8_t mode, uint32_t lng, uint32_t lat, float x, float y, float yaw, float pitch, float heel, float velocity, float course, float rudder, float GyroZ, float electric_current, float voltage)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_USV_STATE_LEN];
	_mav_put_uint32_t(buf, 0, lng);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_usv_state_send(chan, usv_state->mode, usv_state->lng, usv_state->lat, usv_state->x, usv_state->y, usv_state->yaw, usv_state->pitch, usv_state->heel, usv_state->velocity, usv_state->course, usv_state->rudder, usv_state->GyroZ, usv_state->electric_current, usv_state->voltage);
#else
 ...
 */
static inline void mavlink_msg_usv_state_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t mode, uint32_t lng, uint32_t lat, float x, float y, float yaw, float pitch, float heel, float velocity, float course, float rudder, float GyroZ, float electric_current, float voltage)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * @return 
 */
static inline float mavlink_msg_usv_state_get_rudder(const mavlink_message_t* msg)
{
	return _MAV_RETURN_float(msg,  36);
}

/**
 * @brief Get field GyroZ from usv_state message
 *
 * @return 
 */
static inline float mavlink_msg_usv_state_get_GyroZ(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_usv_state_decode(const mavlink_message_t* msg, mavlink_usv_state_t* usv_state)
{
	...
	usv_state->GyroZ = mavlink_msg_usv_state_get_GyroZ(msg);
